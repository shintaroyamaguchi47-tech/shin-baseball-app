...
import { buildAnalytics, normalizeArchive } from '../analyticsData.js';

const game = { id:'g1', date:'2026-07-01', teamTop:'自軍', teamBottom:'相手', data:{ gameInfo:{gameType:'練習試合'}, gameState:{runs:{top:[1,0,2],bottom:[0,1,0]}}, lineups:{top:[{name:'山田',order:1,pos:'遊'}],bottom:[{name:'佐藤',order:1,pos:'投'}]}, pitches:[
