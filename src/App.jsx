              ...
              <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden border border-slate-200">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <label className="flex items-start gap-3 p-4 rounded-2xl border border-slate-200 bg-slate-50 cursor-pointer">
                    ...
                    <span><span className="block font-black text-slate-800">個人成績を付ける</span><span className="block text-xs text-slate-500 mt-1">そのチームの打撃成績・投手成績を、スコアと同じページの右側に載せます。</span></span>
                  </label>
